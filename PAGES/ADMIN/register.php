...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($error)) {
        ...
        $sql = "INSERT INTO pending_users (first_name, last_name, username, email, mobile, password, verification_code) VALUES (?, ?, ?, ?, ?, ?, ?)";

        $stmt = $conn->prepare($sql);
        $stmt->bind_param("sssssss", $first_name, $last_name, $username, $email, $mobile, $password_hashed, $verification_code);
