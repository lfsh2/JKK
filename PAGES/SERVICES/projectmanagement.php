    ...
    <body>
        <header>
            ...
            <div class="responsive-links" id="responsive-dropdown">
                <ul class="links">
                    ...
                    <a href="services.php" class="nav-btn service">SERVICES <i class="fa-solid fa-chevron-down"></i></a>
        ...
        <footer>
            <div class="footer-appointment">
                ...
                <a href="../appointment.php">Get an Appointment <i class="fa-regular fa-paper-plane"></i></a>
            </div>
